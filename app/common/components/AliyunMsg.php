...
require_once __DIR__ . '/dysms/msg_sdk/vendor/autoload.php';
require_once __DIR__ . '/dysms/msg_lib/TokenGetterForAlicom.php';
require_once __DIR__ . '/dysms/msg_lib/TokenForAlicom.php';
 ...
 * Class MsgDemo
 */
class AliyunMsg extends Component
{

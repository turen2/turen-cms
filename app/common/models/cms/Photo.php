...
class Photo extends \app\components\ActiveRecord
{
    ...
    {
        return [
            [['columnid', 'parentid', 'parentstr', 'title', 'colorval', 'boldval', 'flag', 'source', 'author', 'linkurl', 'keywords', 'description', 'content', 'picurl', 'picarr', 'hits', 'orderid', 'posttime', 'lang'], 'required'],

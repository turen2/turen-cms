    ...
    <div class="container">
        <div class="breadcrumb-box clearfix">
            ...
            <?= Breadcrumbs::widget([
                ...
                'links' => Column::ModelBreadcrumbs($model, ['/banjia/news/list'], false),
            ]) ?>
        </div>
                ...
                <div class="detail-text">
                    ...
                    <div class="detail-main">
                        ...
                        <ul>
                            <li>
                                <?php  if($prevModel) { ?>
                                    <a href="<?= Url::to(['/banjia/news/detail', 'slug' => $prevModel->slug]) ?>">
                                        <span class="ap8"></span>
                            ...
                            <li style="float: right;">
                                <?php  if($nextModel) { ?>
                                    <a href="<?= Url::to(['/banjia/news/detail', 'slug' => $nextModel->slug]) ?>">
                                        <span class="ap8"></span>

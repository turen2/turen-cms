            ...
            <div class="midcontent">
                    ...
                    <div class="detail-main">
                        <ul>
                            ...
                            <li style="float: right;">
                                <?php  if($nextModel) { ?>
                                    <a href="<?= Url::to(['/chexing/detail', 'slug' => $nextModel->slug]) ?>">
                                        <span class="ap9"></span>
                ...
                <div class="detail-more">
                    <?= ContentMoreWidget::widget([
                        ...
                        'flagName' => Yii::$app->params['config_face_cn_chexing_column_seemore_flag'],
                        'listNum' => 6,
                    ...
                    <?= ContentMoreWidget::widget([
                        ...
                        'columnType' => 'photo',
                        'columnId' => $model->columnid,
                        'flagName' => Yii::$app->params['config_face_cn_chexing_column_related_flag'],
                        'listNum' => 6,
                        'route' => ['/chexing/detail'],
                    ]); ?>
                </div>

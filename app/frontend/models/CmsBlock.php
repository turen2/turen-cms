 ...
 */
class CmsBlock extends \app\components\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return CmsBlockQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new CmsBlockQuery(get_called_class());
    }
}

...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	<tr align="left" class="head">
		...
		<td width="5%">ID</td>
		<td width="20%"><?= $dataProvider->sort->link('title', ['label' => '投票标题']) ?></td>
		<td width="10%"><?= $dataProvider->sort->link('starttime', ['label' => '开始时间']) ?></td>
		<td width="10%"><?= $dataProvider->sort->link('endtime', ['label' => '结束时间']) ?></td>
		<td width="10%">游客投票</td>
		<td width="10%">查看投票</td>

...
?>
<div class="feedback-type-view wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox">
                ...
                <p>
                    ...
                    <?= Html::a('Update', ['update', 'id' => $model->fkt_id], ['class' => 'btn btn-primary btn-sm']) ?>
                    <?= Html::a('Delete', ['delete', 'id' => $model->fkt_id], [

...
<?php
//-----------------------------------------------
$name = 'config_face_cn_chexing_column_id';
...
<?php
//-----------------------------------------------
$flagName = 'config_face_cn_chexing_column_seemore_flag';
...
<?php
//-----------------------------------------------
$flagName = 'config_face_cn_chexing_column_related_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>
...
<?php
//-----------------------------------------------
$flagName = 'config_face_cn_chexing_column_sidebox_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>

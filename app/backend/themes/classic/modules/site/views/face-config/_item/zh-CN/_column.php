...
<?php
//-----------------------------------------------
$name = 'config_face_cn_home_baike_column_id';
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_home_baike_column_flag';
...
<?php
//-----------------------------------------------
$name = 'config_face_cn_baike_column_id';
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_baike_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];
...
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_news_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];
...
<?php
//-----------------------------------------------
$name = 'config_face_cn_service_column_id';
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_service_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];
...
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_case_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];
...
<?php
//-----------------------------------------------
$name = 'config_face_cn_help_center_column_id';
$value = isset($config[$name])?$config[$name]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];
...
?>
<tr>
    <td class="first-column">系统帮助中心</td>
    <td class="second-column" width="33%">
        <?= Html::dropDownList($name, $value, ArrayHelper::merge([null => '请选择一个配置'], $columnArray), $selectOptions) ?>
    </td>
    <td style="border-bottom: 1px dashed #efefef;">
...
<?php
//-----------------------------------------------
$name = 'config_face_cn_about_us_column_id';
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_cn_about_us_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
$columnArray = [];
$selectOptions = ['id' => $name, 'encode' => false, 'options' => []];
$options = [];

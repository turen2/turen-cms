...
$value = isset($config[$name])?$config[$name]:null;
$flagName = 'config_face_banjia_cn_sidebox_baike_column_flag';
...
<?php
//-----------------------------------------------
$flagName = 'config_face_banjia_cn_sidebox_current_article_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>
...
<?php
//-----------------------------------------------
$flagName = 'config_face_banjia_cn_sidebox_current_photo_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>
...
<?php
//-----------------------------------------------
$flagName = 'config_face_banjia_cn_sidebox_current_file_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>
...
<?php
//-----------------------------------------------
$flagName = 'config_face_banjia_cn_sidebox_current_video_column_flag';
$flagValue = isset($config[$flagName])?$config[$flagName]:null;
?>
<tr>

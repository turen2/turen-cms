...
$buildFilter = BuildHelper::buildFilter(Column::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Column::class, 'id', 'parentid', 'cname', true, $type, 'ArticleSearch', 'columnid', ArrayHelper::merge($addRoutes, [Html::getInputName($model, 'cateid') => $model->cateid]));

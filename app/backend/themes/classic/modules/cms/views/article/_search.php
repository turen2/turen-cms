...
<div class="article-search toolbar-tab">
	<ul class="fl">
        ...
        <li class="line">-</li>
        <li class="<?= (!is_null($model->status) && $model->status == Article::STATUS_ON)?'on':''?>"><?= Html::a('显示', ArrayHelper::merge(['index', Html::getInputName($model, 'status') => Article::STATUS_ON], $addRoutes)) ?></li>
        <li class="line">-</li>

    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="article-form form-table">
    	<tr>
    		...
    		<td class="second-column">
    			<?= BuildHelper::buildSelector($model, 'columnid', Column::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Column::class, 'id', 'parentid', 'cname', true, Column::COLUMN_TYPE_ARTICLE, ['onchange' => 'turen.com.filterField(this);'])?>
    	...
    	<tr>
    		...
    		<td class="second-column">
    			...
    			<div class="slug-input">
        			...
        			<span onclick="turen.com.pinyin(this, document.getElementById('article-title').value);" class="gray-btn slug-btn">推荐值</span>
    			</div>
    		</td>
    	</tr>
    	<tr>
    		...
    		<td class="second-column attr-area">
    			...
    			<?= Html::checkboxList(Html::getInputName($model, 'flag'), array_keys($model->activeFlagList(Column::COLUMN_TYPE_ARTICLE)), Flag::FlagList(Column::COLUMN_TYPE_ARTICLE, true), ['tag' => 'span', 'separator' => '&nbsp;&nbsp;&nbsp;']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr class="nb">

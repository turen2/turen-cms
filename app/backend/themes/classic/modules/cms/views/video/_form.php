    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="video-form form-table">
    	<tr>
    		...
    		<td class="second-column">
    			<?= BuildHelper::buildSelector($model, 'columnid', Column::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Column::class, 'id', 'parentid', 'cname', true, Column::COLUMN_TYPE_VIDEO)?>
    	...
    	<tr>
    		...
    		<td class="second-column attr-area">
    			<?php $model->flag = array_keys($model->getAllFlag(Column::ColumnTypeIdList('video')))//获取选择的标签数组?>
    			<?= Html::activeCheckboxList($model, 'flag', $model->getAllFlag(Column::ColumnTypeIdList('video'), true, true), ['tag' => 'span', 'separator' => '&nbsp;&nbsp;&nbsp;']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr class="nb">

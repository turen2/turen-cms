...
/* @var $searchModel backend\models\cms\ColumnSearch */
		...
		<tbody>
			<tr align="left" class="data-tr">
				...
				<td width="20%" align="center">
					...
					<a href="<?=Url::to(['quick-move', 'type' => Column::ORDER_DOWN_TYPE, 'kid' => $model->id, 'pid' => $model->parentid, 'orderid' => $model->orderid])?>" class="right-arrow" title="下降排序"></a>
				</td>

    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cate-form form-table">
    	<tr>
    		...
    		<td class="second-column">
    			<?= Html::activeDropDownList($model, 'parentid', BuildHelper::buildSelectorData(Cate::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Cate::class, 'id', 'parentid', 'catename'), ['encode' => false, 'class' => '']) ?>

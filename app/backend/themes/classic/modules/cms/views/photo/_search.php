...
/* @var $model backend\models\cms\PhotoSearch */
...
<div class="article-search toolbar-tab">
	<ul class="fl">
        ...
        <li class="line">-</li>
        <li class="<?= (!is_null($model->status) && $model->status == Photo::STATUS_ON)?'on':''?>"><?= Html::a('显示', ArrayHelper::merge(['index', Html::getInputName($model, 'status') => Photo::STATUS_ON], $addRoutes)) ?></li>
        <li class="line">-</li>
        <li class="<?= (!is_null($model->status) && $model->status == Photo::STATUS_OFF)?'on':''?>"><?= Html::a('隐藏', ArrayHelper::merge(['index', Html::getInputName($model, 'status') => Photo::STATUS_OFF], $addRoutes)) ?></li>
        <li class="line">-</li>

...
/* @var $model backend\models\cms\Photo */
...
<?php $form = ActiveForm::begin([
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="photo-form form-table">
    	<tr>
    		...
    		<td class="second-column">
    			<?= BuildHelper::buildSelector($model, 'columnid', Column::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Column::class, 'id', 'parentid', 'cname', true, Column::COLUMN_TYPE_PHOTO, ['onchange' => 'turen.com.filterField(this);'])?>
    	...
    	<tr>
    		...
    		<td class="second-column">
    			...
    			<div class="slug-input">
        			...
        			<span onclick="turen.com.pinyin(this, document.getElementById('photo-title').value);" class="gray-btn slug-btn">推荐值</span>
    			</div>
    		</td>
    	</tr>
    	<tr>
    		...
    		<td class="second-column attr-area">
    			...
    			<?= Html::checkboxList(Html::getInputName($model, 'flag'), array_keys($model->activeFlagList(Column::COLUMN_TYPE_PHOTO)), Flag::FlagList(Column::COLUMN_TYPE_PHOTO, true), ['tag' => 'span', 'separator' => '&nbsp;&nbsp;&nbsp;']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr class="nb">

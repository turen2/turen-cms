    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="photo-form form-table">
    	<tr>
    		...
    		<td class="second-column">
    			<?= BuildHelper::buildSelector($model, 'columnid', Column::find()->current()->orderBy(['orderid' => SORT_DESC])->all(), Column::class, 'id', 'parentid', 'cname', true, Column::COLUMN_TYPE_PHOTO)?>
    	...
    	<tr>
    		...
    		<td class="second-column attr-area">
    			<?php $model->flag = array_keys($model->getAllFlag(Column::ColumnTypeIdList('photo')))//获取选择的标签数组?>
    			<?= Html::activeCheckboxList($model, 'flag', $model->getAllFlag(Column::ColumnTypeIdList('photo'), true, true), ['tag' => 'span', 'separator' => '&nbsp;&nbsp;&nbsp;']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr class="nb">

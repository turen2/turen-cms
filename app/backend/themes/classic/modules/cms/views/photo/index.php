...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	...
	<tr align="left" class="data-tr">
		...
		<td><?= $model->id; ?></td>
		<td><span class="title" style="color:<?= $model->colorval; ?>;font-weight:<?= $model->boldval; ?>"><?= $model->title; ?><span class="title-flag"><?= implode('&nbsp;', $model->getAllFlag(Column::ColumnTypeIdList('photo'))); ?></span><?=empty($model->picurl)?'':' <span class="titpic"><i class="fa fa-picture-o"></i></span>'?></span></td>
		...
		<td><?= EditItemWidget::widget([
		    ...
		    'primaryKey' => 'id',
		    'attribute' => 'orderid',
		    'url' => Url::to(['/cms/photo/edit-item']),
		    'options' => [],
		]); ?></td>
...
<div class="bottom-toolbar">
	...
	<?= Html::a('添加图片信息', ['create'], ['class' => 'data-btn']) ?>
</div>
...
<div class="quick-toolbar">
	<div class="qiuck-warp">
		<div class="quick-area">
			...
			<?= Html::a('添加新图片', ['create'], ['class' => 'data-btn']) ?>

...
<?php $form = ActiveForm::begin([
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="file-form form-table">
    	<tr>
    	...
    	<tr>
    		...
    		<td class="second-column attr-area">
    			...
    			<?= Html::checkboxList(Html::getInputName($model, 'flag'), array_keys($model->activeFlagList(Column::COLUMN_TYPE_FILE)), Flag::FlagList(Column::COLUMN_TYPE_FILE, true), ['tag' => 'span', 'separator' => '&nbsp;&nbsp;&nbsp;']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr class="nb">
    	...
    	<tr>
    		<td class="first-column"><?= $model->getAttributeLabel('dlurl')?><?php if($model->isAttributeRequired('dlurl')) { ?><span class="maroon">*</span><?php } ?></td>
    		<td class="second-column">
    			<?= Html::activeInput('text', $model, 'dlurl', ['class' => 'input']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td class="first-column"><?= $model->getAttributeLabel('filetype')?><?php if($model->isAttributeRequired('filetype')) { ?><span class="maroon">*</span><?php } ?></td>
    		<td class="second-column">
    			<?= Html::activeInput('text', $model, 'filetype', ['class' => 'input']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr>
    		<td class="first-column"><?= $model->getAttributeLabel('filesize')?><?php if($model->isAttributeRequired('filesize')) { ?><span class="maroon">*</span><?php } ?></td>
    		<td class="second-column">
    			<?= Html::activeInput('text', $model, 'filesize', ['class' => 'input']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr>
    		<td class="first-column"><?= $model->getAttributeLabel('website')?><?php if($model->isAttributeRequired('website')) { ?><span class="maroon">*</span><?php } ?></td>
    		<td class="second-column">
    			<?= Html::activeInput('text', $model, 'website', ['class' => 'input']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr>
    		<td class="first-column"><?= $model->getAttributeLabel('demourl')?><?php if($model->isAttributeRequired('demourl')) { ?><span class="maroon">*</span><?php } ?></td>
    		<td class="second-column">
    			<?= Html::activeInput('text', $model, 'demourl', ['class' => 'input']) ?>
    			<span class="cnote"></span>
    		</td>
    	</tr>
    	<tr>

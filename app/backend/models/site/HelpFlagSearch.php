...
use backend\models\site\Flag;

/**
 * HelpFlagSearch represents the model behind the search form about `backend\models\site\HelpFlag`.
 */
class HelpFlagSearch extends HelpFlag
{
    /**
     * @inheritdoc
     */

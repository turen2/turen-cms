...
/**
 * VideoSearch represents the model behind the search form about `app\models\cms\Video`.
 */
class VideoSearch extends Video
{
    ...
    public function rules()
    {
        return [
            ...
            [['parentstr', 'catepstr', 'title', 'colorval', 'boldval', 'flag', 'source', 'author', 'linkurl', 'keywords', 'keyword', 'description', 'content', 'picurl', 'videolink', 'status', 'delstate', 'lang', 'posttime'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query = Video::find()->current()->delstate(Video::IS_NOT_DEL);

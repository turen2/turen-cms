...
/**
 * SrcSearch represents the model behind the search form about `backend\models\cms\Src`.
 */
class SrcSearch extends Src
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'srcname', $this->srcname])

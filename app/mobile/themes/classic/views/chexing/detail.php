    ...
    <div class="guide-detail-box">
        ...
        <dl>
            <dd>
                上一篇：
                <?php  if($prevModel) { ?>
                    <a title="<?= $prevModel->title ?>" href="<?= Url::to(['/chexing/detail', 'slug' => $prevModel->slug]) ?>"><?= $prevModel->title ?></a>
                <?php } else { ?>
            ...
            <dd>
                下一篇：
                <?php  if($nextModel) { ?>
                    <a title="<?= $nextModel->title ?>" href="<?= Url::to(['/chexing/detail', 'slug' => $nextModel->slug]) ?>"><?= $nextModel->title ?></a>
                <?php } else { ?>
                    <a title="没有了" href="javascript:;">没有了</a>
                <?php } ?>
            </dd>

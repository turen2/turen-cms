...
class NewsController extends \mobile\components\Controller
{
    ...
    public function actionList()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Yii::$app->params['config_face_cn_news_column_id']);
        $columnModel = Column::findOne(['id' => Yii::$app->params['config_face_cn_news_column_id']]);

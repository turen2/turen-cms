    ...
    protected function initRewrite()
    {
        ...
        if(GLOBAL_LANG == Yii::$app->params['config_init_default_lang']) {//默认站点规则
            $urlManager->addRules([
                ...
                // FAQ
                ['class' => 'yii\web\UrlRule', 'pattern' => 'faqs', 'route' => 'faqs/list'],
                ['class' => 'yii\web\UrlRule', 'pattern' => 'faqs/<slug:([\w._-]+)>', 'route' => 'faqs/detail'],
                // 服务
                ...
                // 在线咨询
                // ['class' => 'yii\web\UrlRule', 'pattern' => 'online', 'route' => 'online/call'],
